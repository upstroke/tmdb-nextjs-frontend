 ...
 * Contains legal notices and an external source link.
 */
export default function FooterMain() {
  return (
    <div className="main-footer hydrated">
      <footer className="ui bottom fixed inverted menu">
        <nav className="ui inverted segment">
          <ul className="ui inverted secondary text menu">
            ...
            <li>
              <a className="item" href="https://www.imdb.com/" rel="noopener noreferrer" target="_blank">
