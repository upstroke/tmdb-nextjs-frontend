...
/**
 * Generic client component for a paginated media list with Load More.
 *
 * @param {{
    ...
    restorePagedList({
      ...
      fetchPageData: async (pageNumber) => {
        const res = await fetch(
          `/${locale}/${apiPath}?page=${pageNumber}`,
