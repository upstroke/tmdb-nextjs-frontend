...
/**
 * @param {{ navItems?: Array<{id: string, label: string, icon: string, path: string, storageKey: string, active: (pathname: string) => boolean}>, children?: import('react').ReactNode }} props
 */
